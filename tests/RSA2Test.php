...
class RSA2Test extends TestCase
{
    ...
    public function testCreateSecretKey()
    {
        ...
        $res             = $rsaObj->setOpensslConfDir($opensslConfDir)
            ...
            ->setKeyDir($keyDir)
            ->createSecretKey();
        return $this->assertTrue($res !== false);
    }
    ...
    public function testCryptCode()
    {
        ...
        return $this->assertTrue($dData == $data);
    }
    ...
    public function testCACert()
    {
        ...
        $caDecodeData = $rsaObj->certDecrypt(
            $caEncodeData,
            $certPriFile,
            $priKeyPass
        );// CA证书私钥解密（param1 要解密的字符串 param2 CA私钥文件地址 param3 私钥密钥）
        return $this->assertTrue($caDecodeData == $data);
    }
}
